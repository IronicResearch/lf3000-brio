...
#include <stdarg.h>
#include <stdio.h>
#define _g_gnulib_printf printf
#define _g_gnulib_fprintf fprintf
#define _g_gnulib_sprintf sprintf
#define _g_gnulib_snprintf snprintf
#define _g_gnulib_vprintf vprintf
#define _g_gnulib_vfprintf vfprintf
#define _g_gnulib_vsprintf vsprintf
#define _g_gnulib_vsnprintf vsnprintf
#define _g_gnulib_vasprintf vasprintf
