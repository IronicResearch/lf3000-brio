#ifndef __WandCalibrationApp_H__
#define __WandCalibrationApp_H__
...
*******************************************************************************
*
* \file WandCalibrationApp.h
*
* The Wand sample app demonstrates the following:
*  * how to setup and use the VNWandTracking algorithm
*  * how to setup hot spots for wand tracking
...
/*
 *  WandCalibrationApp class.
 *
 *  The WandCalibrationApp class is a direct copy of the STUBApp class.  It
 *  serves as an example of the basic structure and minimum methods and
 *  member variables necessary for an application.
 *
 */
class WandCalibrationApp : public CAppInterface {
public:
  /*!
   * Constructor
   ...
   */
  WandCalibrationApp(void *userData);

  /*!
   * Destructor
   */
  ~WandCalibrationApp(void);
...
#endif // __WandCalibrationApp_H__
