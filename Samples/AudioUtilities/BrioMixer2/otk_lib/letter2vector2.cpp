...
void Otk_Letter2Draw_Vector( float h, char c, float hscale, float vscale, float slant, float xpos, float ypos, float zpos )
{
 ...
 ypos = -ypos;
 Otk_letter_x0 = h;
 Otk_letter_h_scale = 0.15 * hscale;
 Otk_letter_v_scale = 0.13 * vscale;
 Otk_letter_slant = slant;
 Otk_letter_xpos = xpos;
 Otk_letter_ypos = ypos;
 ...
 switch (x)
  {
   ...
   case 40:	/*(*/
	...
	break;
   case 42:	/***/
	Otk_Draw_Vector( 2, 1, 8, 7 );
	Otk_Draw_Vector( 2, 4, 8, 4 );
	Otk_Draw_Vector( 2, 7, 8, 1 );
   ...
   case 111:	/*o*/
	...
	Otk_Draw_Vector( 9,5,9,4 );
	Otk_Draw_Vector( 9,4,7,2 );
	Otk_Draw_Vector( 7,2,6,2 );
	Otk_Draw_Vector( 6,2,4,4 );
	break;
   case 112:	/*p*/
