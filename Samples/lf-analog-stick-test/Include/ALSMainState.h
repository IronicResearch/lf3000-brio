#ifndef ANALOG_STICK_ALS_INCLUDE_ALSMAINSTATE_H_
#define ANALOG_STICK_ALS_INCLUDE_ALSMAINSTATE_H_
...
* \file ALSMainState.h
*
* The ALSMainState class is responsible for handling all button and touch events
* and accelerometer readings.  ALSMainState is the only state in which the ALSApp
* can take on.
*
**
* author: 	leapfrog
 ...
 */
class ALSMainState : public CGameStateBase, public LeapFrog::Brio::IEventListener
{
public:
	/*
	 * Instance
...
protected:
	...
	LF::Hardware::HWAnalogStickMPI*	analog_stick_mpi_;  ///< accelerometer manager
	...
	float		dx_, dy_;          ///< incremental updates to the position
	float		gravity_;
...
private:
	 ...
	 * based on the most current analog stick data
	 */
	int DoAccEventLoop();
...
#endif // ANALOG_STICK_ALS_INCLUDE_ALSMAINSTATE_H_
