...
public:
	void InitDisplay(void)
	{
	    ...
	    current_buffer_ = 0;
	    display_mpi_.Register(display_handles_[0], 0, 0, kDisplayOnTop, kDisplayScreenAllScreens);
	    display_mpi_.Register(display_handles_[1], 0, 0, kDisplayOnTop, kDisplayScreenAllScreens);
	    display_ready_ = true;
	}
