...
printf("psf_asciiheader_printf: LSF_SNPRINTF commented out for Windows build\n");
...
#ifdef _ARM_ASSEM
printf("psf_get_date_str: modified to get past ARM build\n");
#endif

// RESTORE THIS BLOCK FOR NON_ARM BUILD
