...
{	float normfact ;
	...
	while (--count >= 0)
	{	dest [count] = (signed char)lrintf (src [count] * normfact) ;
		} ;
} /* f2sc_array */
...
{	float	normfact, scaled_value ;
	...
	{	scaled_value = src [count] * normfact ;
		...
		dest [count] = (char)lrintf (scaled_value) >> 24 ;
		} ;
} /* f2sc_clip_array */
...
{	double	normfact ;
	...
	while (--count >= 0)
	{	dest [count] = (signed char) lrint (src [count] * normfact) ;
		} ;
} /* d2sc_array */
...
{	double	normfact, scaled_value ;
	...
	{	scaled_value = src [count] * normfact ;
		...
		dest [count] = (signed char) lrintf ((float)scaled_value) >> 24 ;
		} ;
} /* d2sc_clip_array */
