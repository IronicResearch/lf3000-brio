...
BOOST_PP_SEQ_FOR_EACH_I(GEN_ERR_VALUE, LeapFrog::Brio::FirstErr(LeapFrog::Brio::kGroupController), HW_CONTROLLER_ERRORS)
   ...
   */
  const LeapFrog::Brio::U8 kHWMaximumNumberOfControllers = 4; //< maximum number of simultaneously connected controllers
  ...
  static HWControllerLEDColor kHWControllerLEDWhite    = (1 << 6);
