...
typedef Boolean (*tGetStereoAudioStreamFcn)(U16 numSamples, VolatileUncached S16 *pStereoBuffer); 
...
//	
//==============================================================================
//#define kFirstAudioRsrcType		\
// 		 MakeRsrcType(kSystemRsrcGroupAudio, kFirstRsrcTag)
...
//	
//==============================================================================
#define kFirstAudioErr		0x10001C01

enum {
	kAudioCreateTaskErr = kFirstAudioErr,
