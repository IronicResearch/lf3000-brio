...
#	LightningSDK_614.tar.gz		        = Lightning SDK for emulation and embedded development
#	nfsroot_SVN2614.tar.gz			= NFS root filesystem for LF1000 development board
#
#-----------------------------------------------------------------------------------------
# 	PREREQUISIE
#	1. To get LinuxDist-0.11.0-2181.tar.gz	06-Nov-2007 18:11 	 71M
...
#------------------------------------------------------------------------------------------
	...
	export TFTP_MAIN=/home/lfu
	export VERSION=NUM
	export ROOTFS_PATH=/home/lfu/nfsroot
	export PATH_TO_BRIO=/home/boris/workspace/Brio2
	export S_DIR=~/sdrive
